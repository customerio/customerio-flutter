...
import 'package:amiapp_flutter/src/utils/build_info.dart';
    ...
    try {
      ...
      return CustomerIO.initialize(
        config: CustomerIOConfig(
          ...
          region: Region.us,
          logLevel: CioLogLevel.debug, // logLevel,
          autoTrackDeviceAttributes: true, // _sdkConfig?.autoTrackDeviceAttributes,
...
extension AmiAppSDKExtensions on CustomerIOSDK {
  Future<String?> getBuildInfo() async {
    try {
      ...
      BuildInfoMetadata buildInfo = BuildInfoMetadata(packageInfo);
